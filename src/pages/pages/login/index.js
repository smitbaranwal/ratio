...
// import { UserContextConsumer, UserContextProvider, useUserContext } from 'src/utils/context/UserContext'
...
const Index = () => {
  ...
  const {setAccount, setSelectedSafe} = useContext(WalletContext);

  // const { saveWallet } = useUserContext()

  // const {saveWallet} = UserContextProvider()
            ...
            <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
              ...
              <Box sx={{ mb: 6 }}>
                <Typography variant='h5' sx={{ fontWeight: 600, marginBottom: 1.5 }}>
                  Welcome to {themeConfig.templateName}! 👋🏻 Connected wallet: {wallet?.accounts[0].address}
                </Typography>
