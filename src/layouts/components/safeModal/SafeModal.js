...
//  img style
  ...
  return (
    <Dialog onClose={handleClose} open={open} sx={{maxWidth: "150rem"}} className='no-safe'>
      ...
      <Typography variant='body2' fontWeight="regular">Powered by </Typography> 
      <Typography variant='body2' fontWeight="bold" color="black" sx={{marginLeft: "4px"}}>blocknative</Typography>
      </Box>
      </Box>
    </CardContent>
</Grid>
